...
- the SYCL smoke-test entry point and test file
...
cmake -S . -B build-sycl-hw-link \
  ...
  -DSYCL_CKKS_ACCELERATOR_LIBRARY=/home/uwb_student00/Joe/new/SYCL_CKKS_PIPELINE/build-full-hw-fix-exit-drains-YYYYMMDD-HHMMSS/sycl_ckks_accelerator_hw.a \
  -DCMAKE_C_COMPILER=icx \
  -DCMAKE_CXX_COMPILER=icpx
```

Replace `build-full-hw-fix-exit-drains-YYYYMMDD-HHMMSS` with the actual full-hardware build directory.
